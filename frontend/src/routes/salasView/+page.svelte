...
<main>
    <div class="square">
        <div>
            ...
            <div class="salas">
                {#each salas as sala (sala.id)}
                    {#if sala.tipos == "Laboratorio basico" || sala.tipos == "Laboratorio avançado"}
                        <div class="salaSquare">
                            <div class="content">
                                <p>{sala.nome}</p>
                                {#if sala.tipos == "Laboratorio basico"}
        ...
        <div>
            ...
            <div class="salas">
                {#each salas as sala (sala.id)}
                    {#if sala.tipos == "Sala normal" || sala.tipos == "Sala grande" || sala.tipos == "Atelie"}
                        <div class="salaSquare">
                            <div class="content">
                                <p>{sala.nome}</p>
                                {#if sala.tipos == "Sala normal"}
...
<style>
    * {
    ...
    .salas {
        display: grid;
        grid-template-columns: repeat(4, 1fr); /* Define 4 colunas com tamanho flexível */
